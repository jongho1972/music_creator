...
- **7개 카테고리 / 90개 장르 프리셋**
  - 🎛️ EDM/Club — 하우스, 테크노, 트랜스, 하드, 베이스, UK게러지·폰크·아마피아노·하이퍼팝 (25종)
  - 🌆 Chill/Downtempo — 로파이, 칠합, 트립합, 앰비언트, 드론, 베이퍼웨이브, 퓨처게러지 (10종)
  - 🎷 Jazz/Soul/Funk — 비밥, 보사노바, 네오소울, 애시드재즈 (12종)
  - 🎤 Hip-hop/R&B — 붐뱁, 트랩, 드릴, 웨스트코스트, 저지클럽 (8종)
  - 🎸 Rock/Pop — 인디록, 메탈, 블루스, 시티팝, J-pop, 슈게이즈 (15종)
  - 🎻 Classical/Cinematic — 바로크, 미니멀리즘, 시네마틱, 호러 (7종)
  - 🌏 World/Experimental — 국악, 가믈란, 인도 라가, 플라멩코, 레게톤, 방그라, 노이즈 (13종)
- **카테고리 탭 + 장르 드롭다운**으로 빠른 탐색
- **랜덤 장르 버튼**: 전체 프리셋 중 무작위 선택
- **DJ 콘솔**: 필터 / 리버브 / 딜레이 / 크러시 / 템포 / 뮤트 실시간 조작
- **믹스**: 두 스타일의 드럼 + 멜로디 조합
- **변주**: 시드 기반 레이어 셔플 + 일부 장르의 대체 패턴 세트(variants) 사이클
...
- `templates.js` — 90개 장르 템플릿 + CATEGORIES 분류 + 일부 장르의 variants(대체 패턴)
